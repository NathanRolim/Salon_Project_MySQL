...
CREATE TABLE `employee` (
  ...
  `termination_date` varchar(45) DEFAULT NULL,
  `emp_email` varchar(45) NOT NULL,
  `emp_phone` int(15) NOT NULL,
  `location_location_id` int(11) NOT NULL,
  PRIMARY KEY (`employee_id`),
  KEY `fk_employee_location1_idx` (`location_location_id`),
  CONSTRAINT `fk_employee_location1` FOREIGN KEY (`location_location_id`) REFERENCES `location` (`location_id`)
